...
class Monitor:
    def __init__(self, config):
        ...
        self.region_name = config.get('region_name', 'ap-southeast-1')
        self.timezone = config.get('timezone', 'Asia Pacific (Singapore)')
        ...
        while self.monitoring:
            ...
            try:
                if self.capture_screenshots:
                    ...
                    screenshot_path = os.path.join("Desktop_Agent\\project\\app\\assets\\screenshots", f"screenshot_{timestamp}.png")
