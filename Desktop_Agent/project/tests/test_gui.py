...
from app.user_interface import Employee_ActivityApp
import threading
import time
...
def run_gui_test():
    Employee_ActivityApp.Monitor = MockMonitor

    # Initialize the Tkinter root
    root = tk.Tk()
    
    # the Employee_ActivityApp instance
    app = Employee_ActivityApp(root)
